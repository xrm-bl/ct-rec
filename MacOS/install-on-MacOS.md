...
- This instruction and files were based on Macbook Air (2024, Apple M3 chip (8 cores CPU, 10 cores GPU, 16 cores Neural Engine), 24GB unified memory, OS: Sonoma 14.5).
