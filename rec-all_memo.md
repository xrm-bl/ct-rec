...
#### 1. rc-check.bat の実行 (自動CTの場合は act_rc-check.bat)
...
#### 3. 本再構成の実行 gen-all.bat  (自動CTの場合は act_gen-all.bat)
...
#### 1. Run rc-check.bat  (act_rc-check.bat for auto CT)
...
#### 3. Run the Final Reconstruction with gen-all.bat   (act_gen-all.bat for auto CT)
