...
#ifdef WINDOWS
			if (PN<10)     {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%01d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>9)      {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%02d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>99)     {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%03d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>999)    {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%04d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>9999)   {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%05d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>99999)  {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%06d.tif"), (int)(k+1), (int)(kk+1));}
//			if (PN>999999) {snprintf(outfile, sizeof(outfile), ("%03d\\raw\\a%07d.tif"), (int)(k+1), (int)(kk+1));}
#else
			if (PN<10)     {snprintf(outfile, sizeof(outfile), ("%03d/raw/a%01d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>9)      {snprintf(outfile, sizeof(outfile), ("%03d/raw/a%02d.tif"), (int)(k+1), (int)(kk+1));}
			if (PN>99)     {snprintf(outfile, sizeof(outfile), ("%03d/raw/a%03d.tif"), (int)(k+1), (int)(kk+1));}
